...
public class RegistrationValidator implements Validator {
    ...
    public void validate(RegistrationRequest request, Long festivalId, String username, Errors errors) {
        ...
        if (ticketsAlreadyBoughtForFestival + ticketsToBuy > 30) {
            errors.rejectValue("ticketsToBuy", "tickets.limit.exceeded", "Je kan maximaal 30 tickets per festival kopen.");
        }

        // Max 100 tickets in same festival period
        if (totalTicketsInPeriod + ticketsToBuy > 100) {
            errors.rejectValue("ticketsToBuy", "tickets.period.limit.exceeded", "Je kan niet meer dan 100 tickets kopen binnen dezelfde festivalperiode.");
        }
    }
}
